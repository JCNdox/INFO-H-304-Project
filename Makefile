...
projet: main.o Algo.o Blosum.o file.o Phr.o Pin.o Psq.o protlib.o Result.o
	g++ -o projet main.o Algo.o Blosum.o file.o Phr.o Pin.o Psq.o protlib.o Result.o
...
Phr.o: Phr.cpp Phr.h file.h
	g++ -c Phr.cpp
Pin.o: Pin.cpp Pin.h file.h protlib.hh
	g++ -c Pin.cpp
