...
int Algo::scoreCalcul() //ALGORITHME
/* Inspiré de "Faster Smith-Waterman database searches with
inter-sequence SIMD parallelisation" dans les documents fournis sur l'uv*/
{
